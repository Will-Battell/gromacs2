...
#SBATCH --job-name=energy-solvation
#SBATCH --nodes=1
...
FREE_ENERGY=/work/e793/e793/wbattell/binding-energy/solvation-energy
...
do
    ...
    gmx grompp -f $MDP/em_steep_$LAMBDA.mdp -c $FREE_ENERGY/nirma-water.gro -p $FREE_ENERGY/topol.top -o min$LAMBDA.tpr -maxwarn 5
